...
error_reporting(0);
ob_implicit_flush(1);
$token = "6939528270:AAFmRyc9aS4a160WxjsukKhxxsOB5dwFzVs";//توكنك هنا
$tokens = "6939528270:AAFmRyc9aS4a160WxjsukKhxxsOB5dwFzVs"; //توكنك مرة اخرئ
#تعديل وتطوير المنياويبيبو 
...
$text = $message->text;
### ###المنياوي بيبو###تطوير وتعديلات واضافات##
$المنياوي بيبوv = 6236388211; //ايدي حسابك
$sudo =$المنياوي بيبوv;
### ###المنياوي بيبو### المنياوي بيبو ###
$id = $message->from->id;
...
### ###المنياوي بيبو### المنياوي بيبو ###
$sudo = array("$المنياوي بيبوv","6236388211");#ايدي ادمن اخر
$idbot = "6939528270"; #ايدي البوت
$userbot = "@CC_MM_06bot"; #يوزر البوت
$userbots = "@$userbot";//لاتغير شي هون
$buy = "@CC_MM_00"; #معرف المطور
$chi = "@CC_MM_07"; #معرف قناتك
mkdir("sudo");
mkdir("data");
...
if($typee==null){
$typee=$المنياوي بيبوv;
}
### المنياوي بيبو ###
if(!$settingdev["المنياوي بيبو"]){
$em = "- ";}elseif($settingdev["المنياوي بيبو"]){
$em = $settingdev["المنياوي بيبو"];
}
/////۞المنياوي بيبو۞/////
...
$infosudo["info"]["المنياوي بيبوs"]="مفعل";
...
$المنياوي بيبوs=$infosudo["info"]["المنياوي بيبوs"];
...
///۞###المنياوي بيبو### المنياوي بيبو///
if($message and $المنياوي بيبوs=="معطل" and !in_array($from_id,$sudo) and $type =="private" and $chat_id !=$channeladmin){
bot('SendMessage',[
'chat_id'=>$chat_id,
'text'=>"*🕵 | مرحبا بك عزيزي ،
⚠ | #ناسف عن توقف البوت ،
...
[['text'=>"- حالة البوت | $المنياوي بيبوs",'callback_data'=>"المنياوي بيبوs"]],
...
unset($settingdev["المنياوي بيبو"]);
$settingdev = json_encode($settingdev,128|34|256);
file_put_contents("DEVER.json",$settingdev);
}}
...
$infosudo["info"]["المنياوي بيبوs"]="معطل";
file_put_contents("sudo.json", json_encode($infosudo));
bot('editmessagetext',[
'chat_id'=>$chat_id,
...
if($text=="علوشيي" and $from_id!=$المنياوي بيبوv and !in_array($from_id, $sudo) and $type=="private"){
...
###المنياوي بيبو###
if($data == "المنياوي بيبوs"){
$infosudo = json_decode(file_get_contents("sudo.json"),true);
$المنياوي بيبوs=$infosudo["info"]["المنياوي بيبوs"];
if($المنياوي بيبوs=="مفعل"){
$infosudo["info"]["المنياوي بيبوs"]="معطل";
}
if($المنياوي بيبوs=="معطل"){
$infosudo["info"]["المنياوي بيبوs"]="مفعل";
}
file_put_contents("sudo.json", json_encode($infosudo));
sendwataw($chat_id,$message_id);
...
### ###المنياوي بيبو### المنياوي بيبو ###
function المنياوي بيبوZip($المنياوي بيبوZip1, $المنياوي بيبوZip2){
$المنياوي بيبوZip4 = realpath($المنياوي بيبوZip1);
$المنياوي بيبوZip = new ZipArchive();
$المنياوي بيبوZip->open($المنياوي بيبوZip2, ZipArchive::CREATE | ZipArchive::OVERWRITE);
$المنياوي بيبوZip3 = new RecursiveIteratorIterator(
new RecursiveDirectoryIterator($المنياوي بيبوZip4),
RecursiveIteratorIterator::LEAVES_ONLY);
foreach($المنياوي بيبوZip3 as $المنياوي بيبوZip5 => $المنياوي بيبوZip6){

if(!$المنياوي بيبوZip6->isDir()){
$المنياوي بيبوZip7 = $المنياوي بيبوZip6->getRealPath();
$المنياوي بيبوZip8 = substr($المنياوي بيبوZip7, strlen($المنياوي بيبوZip4) + 1);
$المنياوي بيبوZip->addFile($المنياوي بيبوZip7, $المنياوي بيبوZip8);
}}
$المنياوي بيبوZip->close();
}
# كود حجم الملف لـ @MrDGSY #
function المنياوي بيبوZip1($المنياوي بيبوZip9, $المنياوي بيبوZip10 = 2){
$المنياوي بيبوZip11=array(' B', ' KB', ' MB', ' GB', ' TB', ' PB', ' EB', ' ZB', ' YB');
$المنياوي بيبوZip12=floor((strlen($المنياوي بيبوZip9) - 1) / 3);
return sprintf("%.{$المنياوي بيبوZip10}f", $المنياوي بيبوZip9 / pow(1024, $المنياوي بيبوZip12)) . @$المنياوي بيبوZip11[$المنياوي بيبوZip12];
} 
### ###المنياوي بيبو### المنياوي بيبو ###
if($text == "نسخة إحتياطية" or $text == "نسخة" or $text == "/المنياوي بيبو" or $text == "/cope" or $data== "nnn" and in_array($from_id,$sudo)){
$NSSAR = "$المنياوي بيبوv"; //ايديك
date_default_timezone_set("Asia/Damascus");
$time = date("{h-i-s}");
المنياوي بيبوZip('./', "Backup-$time.zip");
bot('sendmessage',[
'chat_id'=>$from_id,
...
File size : ".المنياوي بيبوZip1(filesize("Backup-$time.zip"))." 🏷",
]);
...
[["text"=>"♻️ ⁞ سيرفر ارقام مبيبو ." ,"callback_data"=>"num1"]], 
